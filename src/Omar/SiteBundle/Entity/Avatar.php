...
class Avatar
{
     ...
     * Add dealers
     *
     * @param \Omar\SiteBundle\Entity\Avatar $dealers
     * @return Avatar
     */
    public function addDealer(\Omar\SiteBundle\Entity\Avatar $dealers)
    {
     ...
     * @param \Omar\SiteBundle\Entity\Avatar $dealers
     */
    public function removeDealer(\Omar\SiteBundle\Entity\Avatar $dealers)
    {
